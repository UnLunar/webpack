...
var Ane = require('./ane');  // 头部声明依赖
var Baby = require('./baby');  // 头部声明依赖
var Dust = require('./dust');  // 头部声明依赖
var Fruit = require('./fruit');  // 头部声明依赖
var Halo = require('./halo');  // 头部声明依赖
var Mom = require('./mom');  // 头部声明依赖
var Score = require('./score');  // 头部声明依赖
var Wave = require('./wave');  // 头部声明依赖
...
module.exports = Controller;   // 最后暴露 Controller 类